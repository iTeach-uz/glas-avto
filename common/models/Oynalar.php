...
/**
 * This is the model class for table "oynalar".
 *
 * @property int $id
 *
 * @property OynalarLang[] $oynalarLangs
 */
class Oynalar extends \yii\db\ActiveRecord
{
    ...
    public function behaviors()
    {
        return [
            ...
            'galleryBehavior' => [
                ...
                'type' => 'oynalar',
                'extension' => 'png',
                'directory' => Yii::getAlias('@frontend/web') . '/oynalar/avtooyna/gallery',
                'url' => '/frontend/web/oynalar/avtooyna/gallery',
                'versions' => [
                    'small' => function ($img) {
